...
- Restored a more illustrated fantasy-avatar look while retaining mix-and-match parts and colours.
- Added clear field helper text, an @ prefix for handles, and stronger metadata hierarchy.
- Upgraded cards, shadows, gradients, hover states, profile surfaces, and mobile visual polish.
